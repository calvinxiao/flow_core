...
同工作流任务触发器，FlowCore 提供了支持 STI 的 `FlowCore::TransitionCallback` 模型。
...
- [db/migrate/20200205175444_create_notifications.rb](/test/dummy/db/migrate/20200205175444_create_notifications.rb)

相关模型：

- [app/models/flow_kit/transition_callbacks/notification.rb](/test/dummy/app/models/flow_kit/transition_callbacks/notification.rb)
- [app/models/notification.rb](/test/dummy/app/models/notification.rb)
